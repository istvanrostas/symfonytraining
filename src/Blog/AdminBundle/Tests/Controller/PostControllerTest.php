...
class PostControllerTest extends WebTestCase
{
    ...
    public function testCompleteScenario()
    {
        ...
        //Get author value
        $authorValue = $crawler->filter('#blog_modelbundle_post_author_option:contains("David")')->attr('value');
        ...
        $this->assertGreaterThan(
            0,
            $crawler->filter('td:contains("New post")')->count(), 'The new post is not showing up'
        );
